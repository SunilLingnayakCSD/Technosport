...
import generateReceiptEstimatePdf from '@salesforce/apex/ReceiptPdfAttachment.generateReceiptEstimatePdf';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { NavigationMixin } from 'lightning/navigation';
export default class GenerateInvoicePdf extends NavigationMixin(LightningElement) {
    ...
    // }
    //  get vfPageUrl() {
    //     return `/distributor/apex/EWayBill?id=${this.recordId}`;
    // }
    ...
    get vfPageUrl() {
        ...
        if (this.baseurl.includes("site")) {
            return `${window.location.origin}/distributor/apex/EWayBill?id=${this.recordId}`;
        } else {
            return `${window.location.origin}/apex/EWayBill?id=${this.recordId}`;
        }
