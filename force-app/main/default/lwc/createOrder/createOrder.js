...
export default class MBL_CreateOrder_Comp extends LightningElement {
    userId = Id
    scrollingMessage = [];
    ...
    addToCart() {
        ...
        if (this.checkConditions() === true) {
            ...
            const cartItem = {
                ...
                boxes: this.selectedProduct.boxes != null ? this.selectedProduct.boxes : 0,
    ...
    searchProduct(event) {
        ...
        } else if (searchKey.length === 0 && this.pickval === "CATALOUGE PRODUCT") {
