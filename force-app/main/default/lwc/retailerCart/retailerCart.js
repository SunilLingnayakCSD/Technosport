...
import CreateOrder from '@salesforce/apex/InsertreatilerOrder.CreateOrder';
...
export default class RetailerCart extends LightningElement {
    BackIcon = BackIcon;
    DownArrow = DownArrow;
    @api recordid;
    @track userId = id;
    ...
    handleSave() {
        if (this.selectedProducts.length === 0) {
            ...
            CreateOrder({ productsList: JSON.stringify(this.selectedProducts), recordId: this.userId, visitId: this.recordid, distributorId: this.distributorId })
                .then(result => {
